    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 space-y-4">
          <div>
            <Tooltip content="The percentage of completable quota/day required by the employer, at the submitted EPT">
          ...
          <div className="space-y-2">
            ...
            <div>
              <Tooltip content="The value of the total cost of an employee (estimated at 100% of the pay/year), per employee on average, at the calculated submitted EPT">
